    ...
    <div className="screen join">
      <div className="join-card">
        ...
        <p className="welcome-desc">
          Set a square course with your crew across multiple boats. Share live positions, drop
          marks, and keep the course lined up to the wind — all from your phone, out on the water.
        </p>
        <button className="primary" onClick={onGetStarted}>
          Get started
        </button>
        <p className="hint">
          We'll ask for location and notification access so boats can see each other in real time.
        </p>
      </div>
    </div>
  );
